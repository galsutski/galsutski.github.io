    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <div align="center">
                        <a href="index.php"><img src="../uin.png" alt="logo" width="60%"></a>
                    </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							<li class="active"><a href="index.php"><span>Catatan (Note)</span></a></li>
                            <li>
                                <a href="stock.php"><i class="ti-dashboard"></i><span>Stock Barang BMN</span></a>
                            </li>
							<li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout"></i><span>Transaksi Data BMN
                                    </span></a>
                                <ul class="collapse">
                                    <li><a href="masuk.php">Barang Masuk (Input)</a></li>
                                    <li><a href="keluar.php">Hapus (Rusak, dll)</a></li>
                                </ul>
                            </li>
                            <li>
