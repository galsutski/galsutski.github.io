...
h4{font-size:85%;}
  ...
  <img src="uin.png" width="15%" style="margin-top:4%" \>

	<br \>
			<div class="container">
					<div style="color:white">
					<label><b>UIN Sunan Kalijaga Yogyakarta</b></label><br \><br \>
					<label>Masuk Untuk Melihat Barang Milik Negara UIN</label><br \>
					</div>
                <form method="post">
